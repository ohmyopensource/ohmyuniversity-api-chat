 ...
 * professor is the titular holder ({@code titolareFlg}) of a course edition
 * tracked by OhMyUniversity!.
 *
 ...
 *
 * @param userId            OhMyU user UUID string identifying the professor
